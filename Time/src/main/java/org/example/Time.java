...
*/
        ...
        LocalDateTime dateTime = LocalDateTime.parse(date.format(dateFormat) + "T" + time.format(timeFormat));
    ...
    public static void exercise16(){
        ...
        LocalTime time = LocalTime.parse(dateTime.format(dateFormat));

        LocalDate end = LocalDate.of(2021,5,4);
